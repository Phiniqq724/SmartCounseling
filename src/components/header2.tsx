        ...
        <div className="flex flex-col mt-10">
          ...
          <form action="">
            <div className="flex flex-col">
              <Dropdown DropText="Problem Category" DropVal1="Anything" DropVal2="Personal" DropVal3="Education" DropVal4="Stress" DropVal5="Love Problem" DropVal6="Bully" DropName="Problem" />
              <div className="mt-[25px]">
                <Input3 InText="Problem Description" InType="text" InName="Description" />
              </div>
            </div>
          </form>
          <Footer2 />
